...
public class Kursy implements Serializable {
    ...
    public String toString() {
        return nazwaKursu + ": " + prowadzacy;
    }

    @Override
    public boolean equals(Object obj) {
        if (obj instanceof Kursy kurs) {
            return nazwaKursu.equals(kurs.getNazwaKursu()) && prowadzacy.equals(kurs.getProwadzacy()) && punktyEcts == kurs.getPunktyEcts();
        }
        return false;
    }
