...
1 - ppois(3, 6)
ppois(5, 6) - ppois(2, 6)
plot(0:30, sapply(0:30, function(x) dpois(x, 6)), type="h") 
#największe prawdopodobieństwo że wypadnie ponad 5 samochodów na 2 tygodnie.
...
qexp(0.8, 4)
plot((0:300)/100, sapply((0:300)/100, function(x) dexp(x, 4)), type = "l")
